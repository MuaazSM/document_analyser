...
class DocumentComparatorLLM:
    def __init__(self):
        ...
        self.fixing_parser = OutputFixingParser.from_llm(parser = self.parser, llm = self.llm)      # for fixing maalformed json usign llms
    ...
    def compare_documents(self, combined_docs):
        ...
        try:
            ...
            raise DocumentPortalException("Error during document comparison", sys) from e
