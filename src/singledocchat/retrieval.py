...
class ConversationalRAG:
    def __init__(self, session_id:str, retriever) -> None:
        try:
            ...
            self.contextualize_prompt = PROMPT_REGISTRY.get_prompt(PromptType.CONTEXTUALIZE_QUESTION.value)
            self.qa_prompt = PROMPT_REGISTRY.get_prompt(PromptType.CONTEXT_QA.value)
